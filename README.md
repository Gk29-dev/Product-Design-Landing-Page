...
- In this project, I build Product Design Landing Page.

- I Learned, how to design navigation using flex-box.

- I learned, how to set height of logo image.

- I learned, about icons used in navbar for dropdown menu.

- I learned, about banner image and how we can set height and width of image. 

- I learned, about background-color and color properties.

- I learned, about z-index property. 

- Learned about, margin and padding properties.

- I learned, how to add social icons in footer.
